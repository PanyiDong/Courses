...
with open ('eta_data.txt') as file_object :
...
eta = [(0 * 1) for i in range(times)]
log_eta = [(0 * 1) for i in range(times - 1)]

for i in range(times):
    eta[i] = float(dataset[1][i])
...
plt.figure()
plt.xlabel(r'$\eta$',font2)
plt.ylabel('p',font2)
plt.scatter(eta,cis_possibility,80,'b')
plt.scatter(eta,trans_possibility,80,'r')
plt.plot(eta,cis_possibility,'b-',label=r'$p_{cis}$')
plt.plot(eta,trans_possibility,'r--',label=r'$p_{trans}$')
...
plt.scatter(eta,avg_cis_time,80,'b')
plt.scatter(eta,avg_trans_time,80,'r')
plt.scatter(eta,avg_time,80,'g')
plt.plot(eta,avg_cis_time,'b-',label=r'$\tau_{cis}$')
plt.plot(eta,avg_trans_time,'r--',label=r'$\tau_{trans}$')
plt.plot(eta,avg_time,'g-.',label=r'$\tau$')
plt.legend(prop=font2)
plt.tick_params(labelsize=30)
plt.show()
...
#    total_slope = total_slope + (log_avg_time[i + 1] - log_avg_time[i]) / (log_eta[i + 1] - log_eta[i])/(times - 2)
#    cis_slope = cis_slope + (log_avg_cis_time[i + 1] - log_avg_cis_time[i]) / (log_eta[i + 1] - log_eta[i])/(times - 2)
#    trans_slope = trans_slope + (log_avg_trans_time[i + 1] - log_avg_trans_time[i]) / (log_eta[i + 1] - log_eta[i])/(times - 2)
...
plt.ylabel('t',font2)
plt.title('(a)                                                      ',font1) 
plt.scatter(eta,cis_Nsteps_left,80,'b')
plt.scatter(eta,cis_Nsteps_right,80,'r')
plt.scatter(eta,cis_Ntimes_left,80,'g')
plt.scatter(eta,cis_Ntimes_right,80,'m')
plt.plot(eta,cis_Nsteps_left,'b-',label=r'$s_{cis}$')
plt.plot(eta,cis_Nsteps_right,'r--',label=r'$s_{trans}$')
plt.plot(eta,cis_Ntimes_left,'g-.',label=r'$t_{cis}$')
plt.plot(eta,cis_Ntimes_right,'m:',label=r'$t_{trans}$')
...
plt.ylabel('t',font2)
plt.title('(b)                                                      ',font1) 
plt.scatter(eta,trans_Nsteps_left,80,'b')
plt.scatter(eta,trans_Nsteps_right,80,'r')
plt.scatter(eta,trans_Ntimes_left,80,'g')
plt.scatter(eta,trans_Ntimes_right,80,'m')
plt.plot(eta,trans_Nsteps_left,'b-',label=r'$s_{cis}$')
plt.plot(eta,trans_Nsteps_right,'r--',label=r'$s_{trans}$')
plt.plot(eta,trans_Ntimes_left,'g-.',label=r'$t_{cis}$')
plt.plot(eta,trans_Ntimes_right,'m:',label=r'$t_{trans}$')
plt.legend(prop=font3)
plt.tick_params(labelsize=30)
...
#for i in range(times - 3) :
#    cis_steps_left_slope = cis_steps_left_slope + (log_cis_Nsteps_left[i + 1] - log_cis_Nsteps_left[i])/(log_eta[i + 1] - log_eta[i])/(times - 2)
#   cis_steps_right_slope = cis_steps_right_slope + (log_cis_Nsteps_right[i + 1] - log_cis_Nsteps_right[i])/(log_eta[i + 1] - log_eta[i])/(times - 2)
#    cis_time_left_slope = cis_time_left_slope + (log_cis_Ntimes_left[i + 1] - log_cis_Ntimes_left[i])/(log_eta[i + 1] - log_eta[i])/(times - 2)
#    cis_time_right_slope = cis_time_right_slope + (log_cis_Ntimes_right[i + 1] - log_cis_Ntimes_right[i])/(log_eta[i + 1] - log_eta[i])/(times - 2)
...
#for i in range(times - 3) :
#    trans_steps_left_slope = trans_steps_left_slope + (log_trans_Nsteps_left[i + 1] - log_trans_Nsteps_left[i])/(log_eta[i + 1] - log_eta[i])/(times - 2)
#    trans_steps_right_slope = trans_steps_right_slope + (log_trans_Nsteps_right[i + 1] - log_trans_Nsteps_right[i])/(log_eta[i + 1] - log_eta[i])/(times - 2)
#    trans_time_left_slope = trans_time_left_slope + (log_trans_Ntimes_left[i + 1] - log_trans_Ntimes_left[i])/(log_eta[i + 1] - log_eta[i])/(times - 2)
#    trans_time_right_slope = trans_time_right_slope + (log_trans_Ntimes_right[i + 1] - log_trans_Ntimes_right[i])/(log_eta[i + 1] - log_eta[i])/(times - 2)
...
#trans_right_slope = 0
#for i in range(times - 3) :
#    cis_left_slope = cis_left_slope + (log_cis_left_times_steps[i + 1] - log_cis_left_times_steps[i]) / (log_eta[i + 1] - log_eta[i]) / (times - 2)
#    cis_right_slope = cis_right_slope + (log_cis_right_times_steps[i + 1] - log_cis_right_times_steps[i]) / (log_eta[i + 1] - log_eta[i]) / (times - 2)
#    trans_left_slope = trans_left_slope + (log_trans_left_times_steps[i + 1] - log_trans_left_times_steps[i]) / (log_eta[i + 1] - log_eta[i]) / (times - 2)
#    trans_right_slope = trans_right_slope + (log_trans_right_times_steps[i + 1] - log_trans_right_times_steps[i]) / (log_eta[i + 1] - log_eta[i]) / (times - 2)
